# -*- generated by 1.0.12 -*-
import da
PatternExpr_508 = da.pat.TuplePattern([da.pat.ConstantPattern('r'), da.pat.FreePattern('round_i')])
PatternExpr_522 = da.pat.TuplePattern([da.pat.ConstantPattern('M'), da.pat.FreePattern('p'), da.pat.FreePattern('z'), da.pat.FreePattern('Zv')])
_config_object = {}
import sys
import math
import functools
...
class P(da.DistProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_0', PatternExpr_508, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_507]), da.pat.EventPattern(da.pat.ReceivedEvent, '_PReceivedEvent_1', PatternExpr_522, sources=None, destinations=None, timestamps=None, record_history=None, handlers=[self._P_handler_521])])

    def setup(self, neighbors, sources, clique, idmapping, G, delta, h, **rest_1249):
        super().setup(neighbors=neighbors, sources=sources, clique=clique, idmapping=idmapping, G=G, delta=delta, h=h, **rest_1249)
    ...
    def _P_handler_507(self, round_i):
        self._state.rcount[round_i] += 1
    _P_handler_507._labels = None
    _P_handler_507._notlabels = None

    def _P_handler_521(self, p, z, Zv):
            ...
            if (num_of_entries_z_list < Zv):
                ...
                for i in range((index_z + 1), len(self._state.z_list)):
                    ...
                    if ((z_temp[3] == new_z[3]) and (not z_temp[4])):
                        self._state.z_list.remove(z_temp)
                        break
    _P_handler_521._labels = None
    _P_handler_521._notlabels = None
...
class Node_(da.NodeProcess):
    ...
    def run(self):
        ...
        weights = [(- 2), 2, (- 2), (- 2), (- 2), 4, 2, (- 2), (- 2), 6, (- 2), (- 2), (- 2), (- 2), (- 2), 5, (- 2), (- 2), (- 2), 6, 5, (- 2), 1, (- 2), (- 2), (- 2), (- 2), 1, (- 2), (- 2), 4, (- 2), (- 2), (- 2), (- 2), (- 2)]
        graph = G(weights, n)
