...
class P(da.DistProcess):
    ...
    def setup(self, neighbors, sources, clique, idmapping, G, delta, h, **rest_1228):
        super().setup(neighbors=neighbors, sources=sources, clique=clique, idmapping=idmapping, G=G, delta=delta, h=h, **rest_1228)
...
class Node_(da.NodeProcess):
    ...
    def run(self):
        ...
        weights = [0, 2, (- 1), (- 1), (- 1), 4, 2, 0, (- 1), 9, 1, (- 1), (- 1), (- 1), 0, 5, (- 1), (- 1), (- 1), 9, 5, 0, 1, (- 1), (- 1), (- 1), (- 1), 1, 0, (- 1), 4, (- 1), (- 1), (- 1), (- 1), 0]
        graph = G(weights, n)
